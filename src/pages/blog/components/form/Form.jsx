			...
			<div className="container mx-auto my-3 px-2 lg:px-10">
				...
				<div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl bg-lime-300 mx-40">
					...
					<form onSubmit={handleSubmit}>
						...
						<div className="my-4">
							<textarea name="description" onChange={handleChange} required placeholder="description" className="w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
						</div>
